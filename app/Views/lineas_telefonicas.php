        ...
        <tbody>
          <?php foreach($datos as $lineas): ?>
            <tr>
                ...
                <td>
                <a href="<?= base_url('eliminar_linea/').$lineas['no_telefono']?>" class="btn btn-info"><i class="bi bi-arrow-clockwise">Eliminar</i></a>    
                <a href="<?= base_url('buscar_linea/').$lineas['no_telefono']?>" class="btn btn-info"><i class="bi bi-arrow-clockwise">Actualizar</i></a>    

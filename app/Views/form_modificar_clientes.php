...
<body class="fondo-imagen">
    <div class="container text-center">
        <h1 class="display-1">Agregar Clientes</h1>
        <div class="row justify-content-center">
            <div class="col col-4 border">
                <form action="<?= base_url('modificar_datos_clientes') ?>" method="post">
                    <div class="mb-3">
                        <label for="txtClienteId" class="form-label h4">Id del cliente</label>
                        <br>
                        <input type="text" id="txtClienteId" name="txtClienteId" class="form-control"
                            placeholder="ingrese el id del Cliente">
                    </div>
                    <div class="mb-3">
                        <label for="txtApellido" class="form-label h4">Apellido</label>
                        <input type="text" id="txtApellido" name="txtApellido" class="form-control"
                            placeholder="ingrese su apellido">
                    </div>
                    <div class="mb-3">
                        <label for="txtNombre" class="form-label h4">Nombre</label>
                        <input type="text" id="txtNombre" name="txtNombre" class="form-control"
                            placeholder="ingrese su Nombre">
                    </div>.
                    <div class="mb-3">
                        <label for="txtCorreo" class="form-label h4">Correo Electronico</label>
                        <input type="text" id="txtCorreo" name="txtCorreo" class="form-control"
                            placeholder="ingrese su Correo Electronico">

                    </div>
                    <div class="mb-3">
                        <label for="txtCalle" class="form-label h4">Calle o Avenida</label>
                        <input type="text" id="txtCalle" name="txtCalle" class="form-control"
                            placeholder="ingrese su Calle o avenida">
                    </div>

                    <div class="mb-3">
                        <label for="txtNoCasa" class="form-label h4">No de Casa</label>
                        <input type="text" id="txtNoCasa" name="txtNoCasa" class="form-control"
                            placeholder="ingrese su Numero de Casa">
                    </div>

                    <div class="mb-3">
                        <label for="txtZona" class="form-label h4">Zona</label>
                        <input type="text" id="txtZona" name="txtZona" class="form-control ph-center"
